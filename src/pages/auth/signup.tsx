...
export default function SignUpPage() {
  ...
  return (
    <>
      ...
      <main className="w-full min-h-screen grid place-items-center bg-gray-800">
        <form
        ...
        >
          ...
          <div className="flex flex-col flex-grow items-center justify-center">
            <div className="flex items-center border-b border-gray-100 w-[85%]">
              <AiOutlineUser className="fill-slate-300 text-xl" />
            ...
            <div className="p-3" />
            <div className="flex items-center border-b border-gray-100 w-[85%]">
              <HiOutlineMail className="stroke-slate-300 text-xl" />
              <div className="px-[0.2rem]" />
              <input
                ref={emailInputRef}
                name="email"
          ...
          <div className="text-gray-100">
            Alredy registered?{" "}
            <Link className="text-green-400 font-semibold" href="/auth/signin">
              Sign In
            </Link>
          </div>
        </form>
...
function PasswordInput(passwordInputRef: MutableRefObject<null>) {
  const eyeClassName =
    "absolute fill-slate-300 right-0 top-1/2 -translate-y-1/2";
  ...
  return (
    <div className="flex items-center border-b border-gray-100 w-[85%] relative">
      <BiKey className="fill-slate-300 text-2xl" />
